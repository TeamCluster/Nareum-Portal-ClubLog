...
해시: werkzeug.security 의 pbkdf2 기반 (Flask 의존성)

초기 비밀번호는 db.init_super_db() 가 첫 실행 시 자동 생성해
콘솔에 1회 출력합니다 (db.py 참고).
"""
...
# 새 비밀번호의 최소 길이. 너무 짧으면 무차별대입에 취약.
